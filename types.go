...
var (
	...
	parseableComplex128Type    = reflect.TypeOf(Complex128(0))
	parseableComplex128PtrType = reflect.TypeOf(new(Complex128))
	parseableComplex64Type     = reflect.TypeOf(Complex64(0))
	parseableComplex64PtrType  = reflect.TypeOf(new(Complex64))
)
...
func (n *Complex128) UnmarshalYAML(data []byte) error {
	var s string
...
func (n *Complex64) UnmarshalYAML(data []byte) error {
	var s string
	if err := yaml.Unmarshal(data, &s); err != nil {
		return err
	}
